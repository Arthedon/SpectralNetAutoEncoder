...
Thanks to the SpectralNet formulation of Spectral Clustering using Neural Networks, it is possible to use different methods on the embedding. The goal of this repository is to use an AutoEncoder regularization on SpectralNet in order to keep as much information on the embedding as possible.  
...
Some performances have been tracked for different dataset using the same architecture for SpectralNet, SpectralNet with AutoEncoder and AutoEncoder only :
<table>
